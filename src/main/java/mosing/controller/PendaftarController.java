...
public class PendaftarController {
	...
	public String addSubmit(Model model, @PathVariable(value = "username") String username,
		...
		PendaftarModel pendaftar = new PendaftarModel(username, no_id, nama_id, nama_ijazah, foto, no_hp, no_telp,
				...
				"");
		// PendaftarModel pendaftar = new PendaftarModel(user, no_id, nama_id,
		// nama_ijazah,
		// foto, no_hp, no_telp, negara, kewarganegaraan, alamat_tetap,
		// jenis_id, alamat_sekarang, tanggal_lahir,
		// provinsi, kota, jk, "", "");
